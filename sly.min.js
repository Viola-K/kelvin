  ...
  function d(b, p, q) {
    function K() {
      if (sb.initialized) {
          ...
          (xb = 0),
            Hb.each(function (b, c) {
              ...
              (q.el = c),
                ...
                (q.half = q.size / 2),
                (q.start = xb + (p ? k : 0)),
                (q.center = q.start - G(wb / 2 - q.size / 2)),
                (q.end = q.start - wb + q.size),
                b || (xb += f),
                (xb += o),
                rb.horizontal || i || (n && k && b > 0 && (xb -= I(k, n))),
                b === m && ((q.end += g), (xb += g), (l = p ? n : 0)),
                Ib.push(q),
                (e = q);
            }),
            ...
            Ib.length
              ? ((yb.start = Ib[0][Pb ? "center" : "start"]),
                (yb.end = Pb ? e.center : xb > wb ? e.end : yb.start))
              : (yb.start = yb.end = 0);
        }
        if (
            ...
            a.each(Ib, function (a, b) {
              Pb
                ...
                : b.start + b.size > n &&
                  ...
                  Gb.push(n),
                  (n += wb),
                  n > yb.end && n < yb.end + wb && Gb.push(yb.end));
            });
          else for (; n - wb < yb.end; ) Gb.push(n), (n += wb);
          if (Eb[0] && d !== Gb.length) {
            for (var p = 0; p < Gb.length; p++) o += rb.pageBuilder.call(sb, p);
            (Fb = Eb.html(o).children()),
        ...
        if (
          ...
          sb.initialized
            ? (Jb.activeItem >= Ib.length || (0 === c && Ib.length > 0)) &&
              T(Jb.activeItem >= Ib.length ? Ib.length - 1 : 0, !c)
    ...
    function lb(a) {
      return eb(this)
        ...
        : void (this.parentNode === vb[0] && sb.activate(this));
    }
    function mb() {
    ...
    tb || (b = ub[0]),
      ...
      (sb.add = function (b, c) {
        ...
        Rb
          ? (null == c || !Ib[0] || c >= Ib.length
            ...
            c <= Jb.activeItem && (_b.active = Jb.activeItem += d.length))
          : vb.append(d),
          K();
      }),
      (sb.remove = function (b) {
        if (Rb) {
          ...
          if (c > -1) {
            ...
            c < Jb.activeItem && (_b.active = --Jb.activeItem),
              K(),
      ...
      (sb.destroy = function () {
        return (
          ...
          Hb && Hb.eq(Jb.activeItem).removeClass(rb.activeClass),
          Eb.empty(),
          tb ||
            (ub.unbind("." + r),
            Kb.restore(),
